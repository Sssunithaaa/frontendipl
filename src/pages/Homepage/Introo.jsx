    ...
    <>
      <MainLayout>
        <section className="h-full w-[100vw] scrollbar-hide">
          <div className={` w-[100vw]  mt-20 flex flex-col  `}>
            ...
            <div ref={sectionRefs.fixtures} className=" w-[100vw] ml-4 px-5">
              <motion.h2
                variants={fadeIn("right", "spring", 0.5, 1)}
                whileInView="show"
                viewport={{ once: true, amount: 0.25 }}
                initial="hidden"
                className={`${styles.sectionHeadText} text-left ml-4`}
              >
                Today's fixtures&nbsp;
              </motion.h2>
            ...
            <div className="w-[100vw] px-10">
              <p className={`${styles.sectionHeadText}  ml-4 text-left`}>
                News
              </p>
              <News />
            </div>
            ...
            <div
              ...
              className="lg:w-[100vw] w-full py-10 px-5 lg:px-10  bg-[#eeedf0]"
            >
            ...
            <div
              ...
              className="my-4 w-[100vw] h-[40vh] mt-10 px-10"
            >
              <motion.div>
                ...
                Keep an eye on the <b  className="text-[#38277e]">leaderboard </b>
